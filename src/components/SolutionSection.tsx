    ...
    <section id="servicios" className="py-32 relative">
      <div className="container mx-auto px-6">
        <AnimatedSection className="text-center mb-16">
          <p className="text-primary text-sm uppercase tracking-widest mb-4">Lo que hacemos</p>
          <h2 className="font-heading text-3xl sm:text-4xl md:text-5xl font-bold max-w-3xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-5xl mx-auto">
          {services.map((s, i) => (
            <motion.div
              ...
              className="glass rounded-xl p-7 group hover:glow-neon transition-shadow duration-300 cursor-pointer"
            >
              <div className="w-12 h-12 rounded-lg gradient-neon flex items-center justify-center mb-5">
      ...
      {selected !== null && (
        ...
        >
          ...
          <motion.div
            ...
            className="relative glass rounded-2xl p-8 max-w-lg w-full border border-primary/20 glow-neon z-10 max-h-[80vh] overflow-y-auto"
          >
            <button
              onClick={() => setSelected(null)}
            ...
            <div className="w-14 h-14 rounded-lg gradient-neon flex items-center justify-center mb-6">
              {(() => {
            ...
            <p className="text-primary text-sm mb-4">{services[selected].desc}</p>
